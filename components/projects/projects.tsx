        ...
        <div className="md:block w-full hidden">
          <div className="w-full flex justify-between items-end">
            ...
            <div
              ...
              GO BEYOND <span className="font-bold">BOOKISH KNOWLEDGE</span> BUILD{" "}
              <span className="font-bold">REAL WORLD PROJECT</span>, GET KNOWLDGE ABOUT HOW GITHUB WORKS AND LEARN HOW TO USE IT EFFECTIVELY{" "}
              <span className="font-bold">COLABORATE WITH TEAM</span>{" "}
              {/* <br />I WORK IN A{" "}
